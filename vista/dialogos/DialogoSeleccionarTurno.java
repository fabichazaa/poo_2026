...
public class DialogoSeleccionarTurno extends JDialog {
    ...
    private void construir() {
        ...
        JLabel lblTitulo = new JLabel("Seleccionar Turno");
        lblTitulo.setFont(CargadorFuentes.cargar(16f).deriveFont(Font.BOLD));
        lblTitulo.setForeground(Color.WHITE);

        JLabel lblSub = new JLabel("Elegí un turno para generar el comprobante");
        ...
        // Panel de fondo con bordes redondeados y fondo de cabecera
